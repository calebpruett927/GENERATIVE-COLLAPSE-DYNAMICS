...
def compute_ggl_c_ell(
    ...
    def integrand(z: float) -> float:
        ...
        lensing_kernel, _ = integrate.quad(
            source_kernel, z, config.z_max,
            limit=50, epsrel=config.rel_tol
        )
    ...
    # Outer integral
    C_ell_raw, _ = integrate.quad(
        integrand, config.z_min, config.z_max,
        limit=100, epsrel=config.rel_tol
    )
