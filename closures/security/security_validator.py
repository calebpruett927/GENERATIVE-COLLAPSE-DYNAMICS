...
class SecurityValidator:
    ...
    def compute_invariants(
        self,
        signals: np.ndarray,
        signal_history: Optional[np.ndarray] = None
    ) -> SecurityInvariants:
        """
...
def main():
    ...
    privacy = validator.validate_data_privacy(
        test_data,
        consent_records={"ssn": False},
        is_encrypted=False
    )
