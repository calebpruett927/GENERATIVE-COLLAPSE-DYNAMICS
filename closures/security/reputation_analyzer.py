...
TRUSTED_DOMAINS = [
    ...
    "amazon.com", "cloudflare.com", "stackoverflow.com"
]
...
def detect_homoglyphs(domain: str, known_brands: Optional[List[str]] = None) -> List[str]:
    """
...
def analyze_url_reputation(
    url: str,
    local_blocklist: Optional[List[str]] = None,
...
def analyze_file_hash(
    ...
    local_blocklist: Optional[List[str]] = None,
    local_allowlist: Optional[List[str]] = None
) -> ReputationResult:
    """
