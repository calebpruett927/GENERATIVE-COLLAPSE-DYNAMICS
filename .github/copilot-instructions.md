...
**UMCP v2.2.0** · **8,397 tests** · **20 domains** · **174 closure modules** · **46 lemmas** · **44 structural identities** · **46 dashboard pages**
...
**Version**: 2.2.0 · **Python**: ≥ 3.11 · **License**: MIT

## Architecture

```
src/umcp/
├── __init__.py               # Public API: validate(), MeasurementEngine, __version__ (v2.2.0)
