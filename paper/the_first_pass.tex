...
\begin{tabular}{@{}c@{\,}l@{\quad}l@{\quad}l@{}}
  ...
  \bottomrule
\end{tabular}
\caption{Twelve stops mapped onto the five spine stages.
  Tier-1: kernel and its identities; Tier-0: protocol implementation;
  Tier-2: domain-specific channel selection.
