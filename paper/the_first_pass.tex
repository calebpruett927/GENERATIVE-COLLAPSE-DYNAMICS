...
particles.  Only the Tier-246 closure modules changes---the mapping from raw
...
\begin{itemize}[leftmargin=*,nosep]
  ...
  \item \texttt{closures/closure\_registry.yaml}: lists which Tier-246 closure modules are active for this run.
...
UMCP validation: CONFORMANT
  (repo + casepacks/pedagogical/hello_world),
  errors=0 warnings=0;
...
{"path": "casepacks/pedagogical/hello_world",
 "strict": true}
\end{Verbatim}
...
the framework at any point---any of 23 domains closures, any of the
