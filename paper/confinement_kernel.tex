...
\newcommand{\WeldStatus}{\textcolor{WeldGreen}{\textbf{PROOF BATTERY CLOSED}}}
...
\midrule
$m_{\rm floor}$   & $10^{-11}$ GeV  & mass\_log: $\log_{10}(m/m_{\rm floor})$ \\
$m_{\rm ceil}$    & $200.0$ GeV     & mass\_log: $/\log_{10}(m_{\rm ceil}/m_{\rm floor})$ \\
$\tau_{\rm Planck}$  & $5.391 \times 10^{-44}$ s & stability: $\log_{10}(\tau/\tau_{\rm Planck})$ \\
$\tau_{\rm universe}$ & $4.35 \times 10^{17}$ s & stability: $/\log_{10}(\tau_{\rm universe}/\tau_{\rm Planck})$ \\
$Y_{\rm max}$     & $\max_i |Y_i/2|$ over 17~SM particles & hypercharge normalization \\
$\log_2(9)$       & $\approx 3.17$  & color\_dof: $\log_2(N_c+1)/\log_2(9)$ \\
\midrule
$\eps$ (this paper) & $10^{-6}$ & Guard band (robustness: $10^{-2}$ to $10^{-12}$) \\
\bottomrule
\end{tabular}
\end{table}
