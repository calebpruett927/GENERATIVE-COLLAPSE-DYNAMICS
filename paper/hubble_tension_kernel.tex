...
the standard model --- no Tier-246 closure modules eliminates the gap.
...
In GCD terms: no Tier-246 closure modules (model extension) eliminates
...
In GCD terms, this means no Tier-246 closure modules resolves the
