...
\hline
Gravitational binding & Accumulated $|\kappa|$ from iterations \\
...
Minimum deposit & Minimum $|\Delta\kappa|$ per iteration \\
Cost increase near wells & $\tR$ increases near wells \\
Gradient steepening & $\dd^2\Gam/\dd\omega^2$ \\
Closed deflection & Closed deflection orbit \\
Deflection asymmetry & Controlled by $\Delta = F - \IC$ \\
\end{tabular}
\end{ruledtabular}
\end{table}
