...
Section~\ref{sec:cosmos}.  Each section is self-contained
given the Diagnostic Key.
...
\item \textbf{Lensing classification}:
  ...
  ($0.02 \leq \Delta < 0.10$), thin arc ($\Delta \geq 0.10$).
...
At every other scale, the same diagnostic pattern reappears.
...
Three layers of understanding are now available:
...
force).  Together they yield a fourth layer:
\emph{prediction}.
...
Diagnostic Key item~4) or the dust lane's $0.773$
