...
The AM-GM gap $\Delta \equiv F - \IC \geq 0$ measures channel
...
\item The AM-GM gap amplifies by a factor of $10.8\times$ upon
      binding.
\end{enumerate}
\end{theorem}
...
catastrophically suppresses $\IC$.  This is the AM-GM inequality
...
\begin{enumerate}
\item Row~1 has a larger AM-GM gap than Row~2, because
...
per nucleon have \emph{smaller} AM-GM gaps --- they are more
...
\item \textbf{Charge quantization} (T5) appears as $\IC$
  suppression via the AM-GM inequality.
...
through the common algebra of the AM-GM gap;
...
tightly bound nuclei (iron group) have the smallest AM-GM
