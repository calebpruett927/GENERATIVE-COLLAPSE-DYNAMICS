...
[![Tests: 11,489](https://img.shields.io/badge/tests-11%2C489-brightgreen.svg)](tests/)
...
Tier-1 (44 structural identities, 47 lemmas, 252 proven theorems) → Tier-0 (11,489 tests, 181 closure modules, C++17 accelerator) → Tier-2 (20 domains from particle physics to consciousness). One-way dependency. No back-edges within a frozen run.
...
pytest -v --tb=short                       # 11,489 tests
```
...
2. **Test** — Full pytest suite (11,489 tests, 166 test files)
...
**11,489 tests** across **166 test files**, organized by tier and domain:
...
├── tests/                     # 166 test files, 11,489 tests
