...
class TestLinearKinematics:
    ...
    def test_clipping(self, repo_root: Path) -> None:
        ...
        assert result["oor_flags"]["position"] is True
        assert result["oor_flags"]["velocity"] is True
    ...
    def test_kinematic_consistency(self, repo_root: Path) -> None:
        ...
        result = module.verify_kinematic_consistency(x_series, v_series, a_series, dt=dt, tol=0.05)
...
class TestRotationalKinematics:
    ...
    def test_basic_computation(self, repo_root: Path) -> None:
        ...
        result = module.compute_rotational_kinematics(theta=0.25, omega_rot=0.3, alpha=0.1)
    ...
    def test_angular_momentum(self, repo_root: Path) -> None:
        ...
        result = module.compute_rotational_kinematics(
            theta=0.0, omega_rot=omega, alpha=0.0, I_normalized=moment_of_inertia
        )

        expected_L = moment_of_inertia * omega
    ...
    def test_torque(self, repo_root: Path) -> None:
        ...
        alpha = 0.2
        result = module.compute_rotational_kinematics(
            theta=0.0, omega_rot=0.0, alpha=alpha, I_normalized=moment_of_inertia
        )

        expected_T = moment_of_inertia * alpha
    ...
    def test_rotational_energy(self, repo_root: Path) -> None:
        ...
        expected_E = 0.5 * moment_of_inertia * omega**2
    ...
    def test_centripetal(self, repo_root: Path) -> None:
        ...
        result = module.compute_centripetal(omega_rot=omega, r_normalized=r, m_normalized=m)
...
class TestEnergyMechanics:
    ...
    def test_gravitational_potential(self, repo_root: Path) -> None:
        ...
        m = 1.0
        g = 1.0
        result = module.compute_potential_energy(h=h, m_normalized=m, g_normalized=g, potential_type="gravitational")
    ...
    def test_work_energy_theorem(self, repo_root: Path) -> None:
        ...
        result = module.verify_work_energy_theorem(W_net=W, E_kin_initial=E_i, E_kin_final=E_f)
...
class TestMomentumDynamics:
    ...
    def test_elastic_collision(self, repo_root: Path) -> None:
        ...
        result = module.compute_collision_1d(m1=1.0, v1_initial=0.5, m2=1.0, v2_initial=0.0, collision_type="elastic")

        # Momentum should be conserved
        assert result["momentum_conserved"] is True
    ...
    def test_inelastic_collision(self, repo_root: Path) -> None:
        ...
        result = module.compute_collision_1d(
            m1=1.0, v1_initial=0.6, m2=1.0, v2_initial=0.0, collision_type="perfectly_inelastic"
        )
...
class TestPhaseSpaceReturn:
    ...
    def test_periodic_trajectory_returns(self, repo_root: Path) -> None:
        ...
        result = module.compute_kinematic_return(x_series, v_series, eta_phase=0.1)
    ...
    def test_drifting_trajectory_no_return(self, repo_root: Path) -> None:
        ...
        result = module.compute_kinematic_return(x_series, v_series, eta_phase=0.05)
...
class TestKinematicStability:
    ...
    def test_motion_regime_classification(self, repo_root: Path) -> None:
        ...
        # Static
        result = module.classify_motion_regime(v_mean=0.01, a_mean=0.01, K_stability=0.9, tau_kin=np.inf)
        assert result["motion_regime"] == "Static"

        # Uniform motion
        result = module.classify_motion_regime(v_mean=0.3, a_mean=0.01, K_stability=0.8, tau_kin=np.inf)
        assert result["motion_regime"] == "Uniform"

        # Oscillatory
        result = module.classify_motion_regime(v_mean=0.3, a_mean=0.1, K_stability=0.7, tau_kin=5.0)
    ...
    def test_kinematic_budget(self, repo_root: Path) -> None:
        ...
        result = module.compute_kinematic_budget(
            K_stability_t0=0.7, K_stability_t1=0.75, S_kin=0.1, C_kin=0.05, tau_kin=10.0, R_kin=0.01
        )
...
class TestAxiom0Compliance:
    ...
    def test_non_returning_gets_no_credit(self, repo_root: Path) -> None:
        ...
        result = module.compute_kinematic_return(
            x_series,
            v_series,
            eta_phase=0.001,  # Very tight tolerance
        )
    ...
    def test_compute_kinematic_credit_inf(self, repo_root: Path) -> None:
        ...
        result = module.compute_kinematic_credit(tau_kin=float("inf"), return_rate=0.0)
    ...
    def test_compute_kinematic_credit_finite(self, repo_root: Path) -> None:
        ...
        result = module.compute_kinematic_credit(tau_kin=5.0, return_rate=0.8)
