...
> **Generated**: 2026-03-09 by UMCP v2.2.4 kernel
...
```bash
umcp validate casepacks/ladder/L4_consciousness_kappa_72 --strict
umcp validate casepacks/ladder/L4_ricp_v2_consciousness --strict
```
