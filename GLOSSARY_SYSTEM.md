...
| File | Link Added | Destination |
|------|-----------|-------------|
| [docs/rcft_theory.md](docs/rcft_theory.md) | Quick Reference header | [GLOSSARY.md#tier-2](GLOSSARY.md#tier-2-rcft-overlay-extensions), [SYMBOL_INDEX.md](SYMBOL_INDEX.md) |
| [docs/interconnected_architecture.md](docs/interconnected_architecture.md) | Term Definitions header | All three glossary files |
| [docs/python_coding_key.md](docs/python_coding_key.md) | Protocol Infrastructure header | [GLOSSARY.md](GLOSSARY.md), [SYMBOL_INDEX.md](SYMBOL_INDEX.md) |
| [docs/production_deployment.md](docs/production_deployment.md) | Protocol Infrastructure + Key Terms | [GLOSSARY.md](GLOSSARY.md), specific term links |
