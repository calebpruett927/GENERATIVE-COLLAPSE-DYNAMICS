...
The `raw_measurements.csv` contains 31 rows based on the harmonic oscillator scenario from `casepacks/closures/full/kinematics`, augmented with:
...
```bash
umcp validate casepacks/ladder/L1_kin_ref_phase_oscillator
```
