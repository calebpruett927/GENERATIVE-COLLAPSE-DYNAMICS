...
ROOT = Path(__file__).resolve().parents[2]  # repo root (casepacks/pedagogical/hello_world/..)
...
def main() -> None:
    ...
    inv = {
        ...
        "notes": "Generated by casepacks/pedagogical/hello_world/generate_expected.py",
    }
