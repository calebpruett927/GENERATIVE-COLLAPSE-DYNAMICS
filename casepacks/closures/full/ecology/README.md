...
**Ecology Demonstration Stub**

> ⚠️ **Stub demonstration unit.** This casepack provides minimal packaging
> coverage for the `ecology` domain so that every registered Tier-2
...
- **Casepack ID**: `ecology_stub`
- **Contract**: `UMA.INTSTACK.v1`
- **Canon anchors**: `canon/anchors.yaml`
- **Status**: CONFORMANT (structural stub)
- **Replacement target**: domain-specific raw measurements from `closures/ecology/`
...
```bash
umcp validate casepacks/closures/full/ecology
```

## Where the real domain lives

Closure code, theorems, and tests for `ecology` live at:

- Closures: `closures/ecology/`
- Tests: `tests/test_*ecology*` (and related)
- Full description: `casepacks/TAXONOMY.md` (Coverage Gap section)

## Lineage

- Created: 2026-05-10 (Phase 4 reorg follow-up)
- Reason: TAXONOMY.md Coverage Gap — `ecology` domain had closure
