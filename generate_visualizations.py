...
def create_architecture_diagram():
    ...
    # Vertical connectors
    ax.annotate('', xy=(8, 5.9), xytext=(8, 5.7), arrowprops=dict(arrowstyle='-|>', lw=1.4, color=PALETTE["muted"]))
    ax.annotate('', xy=(8, 3.3), xytext=(8, 3.1), arrowprops=dict(arrowstyle='-|>', lw=1.4, color=PALETTE["muted"]))
    ...
    ax.add_patch(footer)
    ax.text(1.2, 0.53, "Totals: 221 tests • 11 closures • 3 contracts • 3 canon anchors", fontsize=9.5, color=PALETTE["dark"])
    
    plt.tight_layout()
    plt.savefig('architecture_diagram.png', dpi=450, bbox_inches='tight', 
...
def create_architecture_grid():
    ...
    plt.savefig('architecture_grid.png', dpi=450, bbox_inches='tight',
                facecolor='white', edgecolor='none')
...
def create_benchmark_comparison():
    ...
    bars1 = ax1.bar(x - width/2, standard, width, label='Standard', 
                    color='#2E86AB', alpha=0.8)
    bars2 = ax1.bar(x + width/2, umcp, width, label='UMCP', 
    ...
    bars3 = ax2.bar(x2 - width/2, standard_features, width, label='Standard', 
                    color='#2E86AB', alpha=0.8)
    bars4 = ax2.bar(x2 + width/2, umcp_features, width, label='UMCP', 
                    color='#F77F00', alpha=0.8)
...
def create_workflow_diagram():
    ...
    # Step 1: Input
    step1 = FancyBboxPatch((1.0, 6.5), 3.0, 1.2,
                           boxstyle="round,pad=0.04,rounding_size=0.08",
                           edgecolor=PALETTE["tier0"], facecolor='white', linewidth=1.6)
    ax.add_patch(step1)
    ...
    # Arrow
    ax.annotate('', xy=(4.5, 7.1), xytext=(4.1, 7.1),
                arrowprops=dict(arrowstyle='-|>', lw=1.6, color=PALETTE["dark"]))
    
    # Step 2: Invariants
    step2 = FancyBboxPatch((4.7, 6.5), 3.0, 1.2,
                           boxstyle="round,pad=0.04,rounding_size=0.08",
                           edgecolor=PALETTE["tier1"], facecolor='white', linewidth=1.6)
    ax.add_patch(step2)
    ...
    # Arrow
    ax.annotate('', xy=(8.2, 7.1), xytext=(7.8, 7.1),
                arrowprops=dict(arrowstyle='-|>', lw=1.6, color=PALETTE["dark"]))
    
    # Step 3: Closures
    step3 = FancyBboxPatch((8.4, 6.5), 3.0, 1.2,
                           boxstyle="round,pad=0.04,rounding_size=0.08",
                           edgecolor=PALETTE["tier2"], facecolor='white', linewidth=1.6)
    ax.add_patch(step3)
    ...
    ax.annotate('', xy=(6.2, 5.8), xytext=(6.2, 6.4),
                arrowprops=dict(arrowstyle='-|>', lw=1.6, color=PALETTE["dark"]))
    
    # Step 4: Validation
    step4 = FancyBboxPatch((4.7, 4.3), 3.0, 1.2,
                           boxstyle="round,pad=0.04,rounding_size=0.08",
                           edgecolor=PALETTE["accent"], facecolor='white', linewidth=1.6)
    ax.add_patch(step4)
    ...
    # Arrow down
    ax.annotate('', xy=(6.2, 3.5), xytext=(6.2, 4.1),
                arrowprops=dict(arrowstyle='-|>', lw=1.6, color=PALETTE["dark"]))
    
    # Step 5: Receipt
    step5 = FancyBboxPatch((4.7, 2.1), 3.0, 1.2,
                           boxstyle="round,pad=0.04,rounding_size=0.08",
                           edgecolor=PALETTE["tier0"], facecolor='white', linewidth=1.6)
    ax.add_patch(step5)
    ...
    # Side info boxes
    # Canon
    canon_box = FancyBboxPatch((0.9, 4.3), 2.8, 1.2,
                               boxstyle="round,pad=0.05,rounding_size=0.06",
                               edgecolor=PALETTE["muted"], facecolor=PALETTE["light"],
    ...
    # Contract
    contract_box = FancyBboxPatch((10.0, 4.3), 2.8, 1.2,
                                  boxstyle="round,pad=0.05,rounding_size=0.06",
                                  edgecolor=PALETTE["muted"], facecolor=PALETTE["light"],
                                  linewidth=1, linestyle='--')
    ...
    # Registry
    registry_box = FancyBboxPatch((10.0, 2.1), 2.8, 1.2,
                                  boxstyle="round,pad=0.05,rounding_size=0.06",
                                  edgecolor=PALETTE["muted"], facecolor=PALETTE["light"],
                                  linewidth=1, linestyle='--')
    ...
    # Output description
    output_box = FancyBboxPatch((1.0, 0.5), 12.0, 1.2,
                                boxstyle="round,pad=0.06,rounding_size=0.06",
                                edgecolor=PALETTE["accent"], facecolor="white",
                                linewidth=1.2)
    ...
    legend = FancyBboxPatch(
        ...
        edgecolor=PALETTE["line"], facecolor="white", linewidth=1.0
    )
    ax.add_patch(legend)
    ...
    plt.tight_layout()
    plt.savefig('workflow_diagram.png', dpi=450, bbox_inches='tight',
                facecolor='white', edgecolor='none')
...
def create_workflow_vertical():
    ...
    for i, (s, a, b, color) in enumerate(steps):
        ...
        if i < len(steps) - 1:
            ax.annotate('', xy=(5, y - 0.3), xytext=(5, y),
    ...
    plt.savefig('workflow_vertical.png', dpi=450, bbox_inches='tight',
                facecolor='white', edgecolor='none')
